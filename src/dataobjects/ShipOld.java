...
public class ShipOld {
    ...
    public ShipOld(String n, int d, int ln, int x, int y) {
        name = n;
        length = ln;
        dir = d;
        x1 = x;
    ...
    public ShipOld(String name, int direction, int length, int x, int y, int ex, int ey) {
        this.name = name;
    ...
    public ShipOld compinput(int u, int n) {
        ShipOld boat;
        ...
        do {
            ...
            boat = new ShipOld(UI.getShips(u), dir, shipl, x, y);
            switch (dir) {
                case 0:
